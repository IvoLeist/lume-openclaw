...
Focus on architecture, readability, performance implications, and provide actionable suggestions for improvement.
...
- [ ] Code does what it's supposed to do and matches requirements
...
- [ ] Functions are small and focused; variable names are descriptive
- [ ] No unnecessary duplication or dead code
- [ ] Follows project conventions; tests/documentation updated as needed

### Security & Safety

- [ ] No obvious security vulnerabilities introduced
- [ ] Inputs validated and outputs sanitized; no hardcoded secrets
- [ ] Sensitive data handled correctly; performance regressions considered
